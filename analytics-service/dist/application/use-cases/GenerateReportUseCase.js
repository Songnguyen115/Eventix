...
class GenerateReportUseCase {
    ...
    async execute(data) {
        ...
        try {
            ...
            await this.analyticsRepository.updateReport(createdReport.id, {
                status: Report_1.ReportStatus.FAILED,
            });
            throw error;
        }
    }
    ...
    async generateSurveyReport(filters) {
        return {
            summary: {
                totalSurveys: 3,
                totalResponses: 85,
    ...
    async generateSponsorReport(filters) {
        return {
            summary: {
                totalSponsors: 5,
                totalBoothVisits: 45,
